# List of talks delivered in various conferences/meetups in 2020
...
Find the slides [here](Interview-tips.pdf).
...
Find the slides [here](Speaking_conferences_proposalwriting.pdf).
...
Find the slides [here](CaseforREST.pdf) and the recording [here](https://www.twitch.tv/videos/1209422721?t=502m26s).
...
Find the slides [here](DependencyManagementUsingGit.pdf) and recording [here](https://githubuniverse.com/content-library/dependency-management-using-git/).
...
Find the slides [here](Women-tech-careers-extra-leap.pdf). Recording link will be available soon.
...
Find the slides [here](Demystifying-use-cases-REST-gRPC-GraphQL.pdf). Find it on [Youtube](https://www.youtube.com/watch?v=kvMUNlqp44s).
...
Find the slides [here](Make-most-open-source-foreignadmits.pdf). Find it on [Youtube](https://www.youtube.com/watch?v=qhF8wGET3E4).
...
Find the slides [here](Make-the-most-of-open-source.pdf).
...
Find the slides [here](Level-up-with-GitHub-actions-bots-CI-CD.pdf) and the recording [here](https://www.girl-code.co.uk/community/events/open-source-day-event-recording).
#### Demystifying use cases of REST, gRPC and GraphQL 
>> *Presented as a part of Summit@Sites organized by Red Hat on May 20, 2021*

This session covers API timelines, constraints, common myths and solutions, advantages, disadvantages and use cases for each of REST, GraphQL and gRPC to help solve the API developer's dilemma. 

Find the slides [here](Demystifying-use-cases-REST-gRPC-GraphQL.pdf).
...
Find the detailed curriculum [here](GS-Web-Dev-Intermediate/Curriculum.md).
